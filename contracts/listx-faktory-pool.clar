      ...
      ;; Define LP token
      (define-fungible-token STX-LiSTX)
      ...
      (define-public (transfer (amount uint) (sender principal) (recipient principal) (memo (optional (buff 34))))
          (begin
              ...
              (try! (ft-transfer? STX-LiSTX amount sender recipient))
      ...
      (define-read-only (get-balance (who principal))
          (ok (ft-get-balance STX-LiSTX who)))
  
      (define-read-only (get-total-supply)
          (ok (ft-get-supply STX-LiSTX)))
      ...
      (define-read-only (get-reserves-quote)
          (let (
              (reserves (get-reserves))
              (supply (ft-get-supply STX-LiSTX)))
              {
                dx: (get a reserves),
                dy: (get b reserves),
                dk: supply
